...
public class LatlngDistance implements Cloneable {
     ...
     */
    public LatlngDistance(double longitude, double latitude) {
     ...
     */
    public LatlngDistance(double longitude, double latitude, boolean isCheck) {
        if (isCheck) {
            if ((-180.0D <= longitude) && (longitude < 180.0D)) this.longitude = parse(longitude);
            else {
...
//            this.latitude = parse(Math.max(-90.0D, Math.min(90.0D, latitude)));
    ...
    public LatlngDistance clone() {
        return new LatlngDistance(this.latitude, this.longitude);
    }
    ...
    public boolean equals(Object obj) {
        ...
        LatlngDistance other = (LatlngDistance) obj;
